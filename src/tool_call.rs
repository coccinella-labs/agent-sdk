...
mod tests {
    ...
    fn tool_call_source_from_provider() {
        assert_eq!(
            ToolCallSource::from_provider(&Provider::OpenAI),
            ToolCallSource::OpenAi
        );
        assert_eq!(
            ToolCallSource::from_provider(&Provider::Sambanova),
            ToolCallSource::Sambanova
        );
        assert_eq!(
            ToolCallSource::from_provider(&Provider::OpenRouter),
            ToolCallSource::OpenRouter
        );
        assert_eq!(
            ToolCallSource::from_provider(&Provider::Zen),
            ToolCallSource::Zen
        );
        assert_eq!(
            ToolCallSource::from_provider(&Provider::Gemini),
            ToolCallSource::Gemini
        );
        assert_eq!(
            ToolCallSource::from_provider(&Provider::Ollama),
            ToolCallSource::Ollama
        );
    }
